    $(document).ready(function() { // applied
        ...
        $("#wordClassList").click(function(e) {
            e.preventDefault();
            window.location.href = BASE_URL + 'app_open_article/';
        });
        ...
        $("#wordCheckButton").click(function(e) {
            ...
            var sourceTitle = $("#src_title").val(); 
            var sourceType  = $("#src_type").val(); 
            var url = '/app_word_work/main-wordcheck/?source_url=' + encodeURIComponent(sourceUrl) + '&source_title=' + encodeURIComponent(sourceTitle) + '&source_type=' + encodeURIComponent(sourceType)  + '&source_status=C';
