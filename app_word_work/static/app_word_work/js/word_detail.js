    $(document).ready(function() { // applied
        ...
        $("#wordClassList").click(function(e) {
            e.preventDefault();
            window.location.href = BASE_URL + 'app_word_work/';
        });
        ...
        $("#submitButton").click(function() {
            ...
            $.ajax({
                url: '/app_word_work/save-wordinfo/',
                type: 'GET',
                data: data,
        ...
        $("#completeButton").click(function() {
           ...
           var complt_title    = $("#wrd_title").val(); 
            ...
            $.ajax({
                url: '/app_word_work/complete-word/',
                type: 'GET',
                data: data,
                success: function(response) {
                  $("#resMessage").val(response.message);
                  var complt_voca     = "completed-go-to-next-word"; 
                  window.location.href = BASE_URL + 'app_word_work/word_detail/?word=' + encodeURIComponent(complt_voca)  + '&wrd_title=' + encodeURIComponent(complt_title);
                },
                error: function(xhr, status, error) {
                  $("#resMessage").val("error : " + error);
                }
