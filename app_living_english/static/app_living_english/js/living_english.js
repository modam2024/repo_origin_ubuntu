    $(document).ready(function() { // applied
        ...
        $("#wordCheckButton").click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    let living_url = '/app_word_work/main-wordcheck/?source_url=' + encodeURIComponent(sourceUrl) + '&source_title=' + encodeURIComponent(sourceTitle) + '&source_type=' + encodeURIComponent(sourceType)  + '&selected_chapter=' + encodeURIComponent(selChapter)  +  '&source_status=C&gubun=living';
